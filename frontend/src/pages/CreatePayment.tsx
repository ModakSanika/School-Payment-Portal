// frontend/src/pages/CreatePayment.tsx
...
const CreatePayment: React.FC = () => {
  ...
  const validateForm = (): boolean => {
    ...
    if (formData.amount < 1 || formData.amount > 100000) {
  ...
  const createPaymentRequest = async (): Promise<PaymentResponse> => {
    try {
      ...
      const response = await apiService.post('/payments/create-payment', {
        ...
        redirect_url: `${window.location.origin}/dashboard/transactions`
      });
      ...
      return {
        ...
        Collect_request_url: response.data.payment_url || response.data.Collect_request_url,
